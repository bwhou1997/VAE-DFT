...
# I copy Variational_autoencoder_train.py to this, and save the model as MoS2_model.pth for clearer demonstration
# Note: there is no any difference between this and oroginal variational AE, this new file is only used for avoiding mixing with the VAE for NN.
